...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGVyY2l2YWwzMyIsImEiOiJjbGVndTk1NXkwOTEyM3Btd2xpNWo2N3E2In0.GfFvB9Ji_IphRcDpEBk4Ow';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/percival33/cleh6wibd003m01kguyd2aoge',
    // style URL
    scrollZoom: false
  });
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MiGbcEwYauv13Cp2EoYxrkdrJdUm1D5eComB8YfK3vjuEeQhhbJuolhBGM3xBcmGQESD40GI9iWhL6Q0FBYAwwF0049O6QUeK');
          _context.prev = 1;
          _context.next = 4;
